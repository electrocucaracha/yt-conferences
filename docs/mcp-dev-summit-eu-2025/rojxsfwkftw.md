...
|   # | Main point                                                                                          |
| --: | --------------------------------------------------------------------------------------------------- |
|   1 | Developer appreciates using notes in MCP for documenting code during development.                   |
|   2 | Enjoys writing code, prompts, and documentation simultaneously with context.                        |
|   3 | Expects exponential growth in MCP due to high energy and diverse experimentation.                   |
|   4 | MCP specification is frequently updated.                                                            |
