...
|  10 | Shift toward a "demo culture" where ideas are quickly prototyped and shown rather than pitched.                                     |
|  11 | AI use has led to new engineering processes, termed "compounding engineering."                                                      |
|  12 | In compounding engineering, each feature should make the next feature easier to build.                                              |
|  13 | The compounding engineering loop: plan, delegate, assess, codify.                                                                   |
|  14 | Codifying knowledge into prompts and libraries enables organization-wide sharing and reuse.                                         |
|  15 | Tacit code sharing is easier; AI can learn from other repos and adapt code across products.                                         |
|  16 | New hires and freelancers are productive on day one due to codified processes and agent support.                                    |
