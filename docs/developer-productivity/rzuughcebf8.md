...
As a freelancer, Devon has worked on various web development projects, but recently took on an embedded application project using Elixir.
He found that deploying code on hardware without access was a significant challenge, as it limited his ability to iterate and fix bugs.
...
[Watch on YouTube](https://www.youtube.com/watch?v=rZuUGHCeBf8)
