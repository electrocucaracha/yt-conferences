...
The event concluded with expressions of gratitude to all attendees, platinum sponsors, diamond sponsors, and the startup sponsor, highlighting the event's popularity and strong support.
...
|   # | Main point                                                                     |
| --: | ------------------------------------------------------------------------------ |
|   1 | Event sessions have concluded.                                                 |
|   2 | Appreciation expressed to all platinum sponsors.                               |
|   3 | Appreciation expressed to all diamond sponsors.                                |
|   4 | Appreciation expressed to the startup sponsor.                                 |
|   5 | Event attendance is high.                                                      |
|   6 | Drinks and appetizers are available for all attendees at the collocated event. |
|   7 | Reception is hosted at Hall B1, Level 1.                                       |
|   8 | Confusion about the reception date; calendar indicates it is on Monday.        |
|   9 | Organizers thanked for their efforts.                                          |
