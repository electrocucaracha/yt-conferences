...
|   3 | Prompts: Predefined templates for AI interactions; can be dynamic and fetch data; support argument autocompletion; easy to implement in editors like VS Code.                                                |
