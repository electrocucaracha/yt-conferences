...
|   9 | CLI tools avoid context overload by progressive discovery; models know common CLI tools from training data and can use help commands to learn new ones.   |
|  10 | CLI tools are run as code in sandbox environments, allowing efficient context management.                                                                 |
