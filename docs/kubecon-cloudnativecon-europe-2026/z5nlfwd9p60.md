...
|   8 | Exploring use case: Running LLM agents fully inside browsers, specifically with VS Code LLMlet.                                                                         |
|   9 | VS Code LLMlet is an experimental extension for browser-based VS Code, running LLMs on WASM or WebGPU inside the browser using llama.cpp.                               |
...
|  13 | Demo: Ran VS Code for the web with LLMlet, using QN 3.54B.                                                                                                              |
