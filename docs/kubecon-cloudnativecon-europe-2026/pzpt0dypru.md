...
The presentation discusses how Kubernetes governs itself, focusing on its release cycle, governance structure, and ways to stay current and contribute.
Kubernetes releases occur three times a year, and while knowledge may become slightly outdated after a few releases, the core remains relevant.
...
|   # | Main point                                                                                                                                    |
| --: | --------------------------------------------------------------------------------------------------------------------------------------------- |
|   1 | Kubernetes releases three times a year; core knowledge remains relevant for several releases.                                                 |
|   2 | CNCF is the overarching organization for Kubernetes, but Special Interest Groups (SIGs) do most of the work.                                  |
|   3 | SIGs manage specific areas within Kubernetes; subprojects and working groups address specific or cross-functional issues.                     |
|   4 | Technical Advisory Groups (TAGs) advise on cross-cutting concerns across the CNCF ecosystem but do not own code.                              |
|   5 | SIGs focus on Kubernetes; TAGs cover broader CNCF projects.                                                                                   |
...
|  13 | Kubernetes security announcements (Google Group)                                                                                              |
|  14 | Kubernetes blog                                                                                                                               |
|  15 | Official JSON feed for releases                                                                                                               |
|  16 | Operators should prioritize subscribing to security announcements and release feeds.                                                          |
|  17 | To contribute, join Kubernetes or CNCF Slack, introduce yourself, and attend SIG sessions or meet-and-greets at events like KubeCon.          |
