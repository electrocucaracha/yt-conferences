...
|  18 | New website launched with more interactive and built-in function examples.                                |
|  19 | Feedback form added to website; positive feedback outweighs negative.                                     |
...
|  23 | Regal tool: linter and language server for Rego, now supports IntelliJ, 107 lint rules, high performance. |
