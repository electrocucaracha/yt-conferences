...
|   7 | Workload anti-affinity: schedule workloads to separate clusters for high availability using group-by label keys; also supports colocateion of workloads                                                            |
