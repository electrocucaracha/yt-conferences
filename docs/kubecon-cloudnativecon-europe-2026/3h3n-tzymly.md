---
type: Video Note
title: "Enforce VIP Access Only Through Node Attestation - Alice Frosi & Jakob Naucke, Red Hat"
description: "Alicha Frosi and Jacob N. from Reddit present on confidential computing and attestation in cluster environments, likening a secure cluster to an exclusive club where only authorized entities can access sensitive data. They explain that conf..."
