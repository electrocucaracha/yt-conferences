...
|   3 | Five case studies are available on the CNCF website; Baidu reduced inference task costs by two-thirds using Hami, and SF Express used custom memory isolation for workload stability. |
