...
CubeCon CloudNative Con Europe has returned to Amsterdam, welcoming attendees to the event.
...
|   # | Main point                                                   |
| --: | ------------------------------------------------------------ |
|   1 | CubeCon CloudNative Con Europe is taking place in Amsterdam. |
|   2 | Day zero included collocated events and lightning talks.     |
|   3 | The main event is scheduled for tomorrow.                    |
|   4 | Attendees are encouraged to keep cloud native moving.        |
