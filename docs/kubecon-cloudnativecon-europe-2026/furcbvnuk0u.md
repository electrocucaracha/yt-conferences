...
|   2 | NGINX Ingress is being retired; no further releases, bug fixes, or security patches.                                                                                        |
...
|  12 | WASM extensibility for hot-reloading plugins in multiple languages (Golang, Rust, C++, JavaScript).                                                                         |
