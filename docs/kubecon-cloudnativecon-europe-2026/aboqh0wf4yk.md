---
type: Video Note
title: "Navigating the Gateway API Maze: 40+ Implementations, 55+ Features... Beka Modebadze & Christine Kim"
description: 'The presentation, "Navigating the Gateway API Maze," discusses the evolution from Kubernetes'' Ingress API to the Gateway API, highlighting the limitations of Ingress—such as lack of portability, complexity from annotations, and shared objec...'
