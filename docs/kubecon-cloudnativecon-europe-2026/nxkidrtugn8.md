...
|  16 | Direct clone: simple, but repository structure and CI are tied to Headlamp.                                                            |
...
|  19 | Submodule pointing to same repository but different branches: used in AKS Desktop; maintains separate histories within one repository. |
