...
|   3 | KEPs (Kubernetes Enhancement Proposals) are design documents for new features and deprecations in Kubernetes, stored in the k/enhancements GitHub repository.                                                                  |
...
|   7 | To propose a KEP, contributors fill out a template, get SIG lead review, and submit to the k/enhancements repository.                                                                                                          |
