...
|  11 | Introduced four verification policies for pre-loaded images: always verify, never verify pre-loaded images (default), never verify allow-listed images, and never verify. |
