...
description:
  ...
  systems, highlighting the complexity of the task and the widespread use of the BLEU
  metric, which measures n-gram overlap between machine-generated and reference transla...
