...
| :---------------------------------------------------------------------------------------------------- | :---------------------------------------------------- | :----------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------- |
| Stanford CME295 Transformers & LLMs \| Autumn 2025 \| Lecture 1 - Transformer                         | Afin & Shervin (Stanford CME 295)                     | [docs/large-language-models-llms/ub3gofaucds.md](docs/large-language-models-llms/ub3gofaucds.md) | Introduces transformer fundamentals, self-attention, tokenization, embeddings, and sequence modeling evolution from RNNs.           |
| Stanford CME295 Transformers & LLMs \| Autumn 2025 \| Lecture 2 - Transformer-Based Models & Tricks   | Afin & Shervin (Stanford CME 295)                     | [docs/large-language-models-llms/yt84y5zcnaa.md](docs/large-language-models-llms/yt84y5zcnaa.md) | Explores RoPE positional embeddings, RMSNorm, GQA/MQA, and architecture families including BERT, T5, and decoder-only LLMs.         |
| Stanford CME295 Transformers & LLMs \| Autumn 2025 \| Lecture 3 - Tranformers & Large Language Models | Afin & Shervin (Stanford CME 295)                     | [docs/large-language-models-llms/q5balehv5so.md](docs/large-language-models-llms/q5balehv5so.md) | Details decoder-only scaling, Mixture of Experts (MoE), decoding strategies, prompting, and KV caching inference efficiency.        |
| Stanford CME295 Transformers & LLMs \| Autumn 2025 \| Lecture 4 - LLM Training                        | Afin & Shervin (Stanford CME 295)                     | [docs/large-language-models-llms/vla-jt-3qc4.md](docs/large-language-models-llms/vla-jt-3qc4.md) | Covers pre-training at scale, scaling laws, distributed parallel training with ZeRO and FlashAttention, SFT, and LoRA.              |
| Stanford CME295 Transformers & LLMs \| Autumn 2025 \| Lecture 5 - LLM tuning                          | Afin & Shervin (Stanford CME 295)                     | [docs/large-language-models-llms/pmw-tmq3l0i.md](docs/large-language-models-llms/pmw-tmq3l0i.md) | Analyzes preference alignment using pairwise human feedback, reward modeling, PPO/RLHF, and DPO alternatives.                       |
| Stanford CME295 Transformers & LLMs \| Autumn 2025 \| Lecture 6 - LLM Reasoning                       | Afin & Shervin (Stanford CME 295)                     | [docs/large-language-models-llms/k5fh-ugtuco.md](docs/large-language-models-llms/k5fh-ugtuco.md) | Examines multi-step reasoning, chain-of-thought, pass@k evaluation, GRPO reinforcement learning, and DeepSeek-R1.                   |
| Stanford CME295 Transformers & LLMs \| Autumn 2025 \| Lecture 7 - Agentic LLMs                        | Afin & Shervin (Stanford CME 295)                     | [docs/large-language-models-llms/h-7s6hnq0vg.md](docs/large-language-models-llms/h-7s6hnq0vg.md) | Covers RAG architecture, tool and function calling, Model Context Protocol (MCP), ReAct agent loops, and agent safety.              |
| Stanford CME295 Transformers & LLMs \| Autumn 2025 \| Lecture 8 - LLM Evaluation                      | Afin & Shervin (Stanford CME 295)                     | [docs/large-language-models-llms/8fnp4n46rro.md](docs/large-language-models-llms/8fnp4n46rro.md) | Compares human evaluation, rule-based metrics, and LLM-as-a-judge frameworks while addressing position and verbosity biases.        |
| Stanford CME295 Transformers & LLMs \| Autumn 2025 \| Lecture 9 - Recap & Current Trends              | Afin & Shervin (Stanford CME 295)                     | [docs/large-language-models-llms/q86qzj1k1ss.md](docs/large-language-models-llms/q86qzj1k1ss.md) | Recaps full LLM lifecycle and explores vision transformers, multimodal integration, diffusion LLMs, and open challenges.            |
| Stanford CS224N: NLP w/ DL \| Spring 2024 \| Lecture 12 - Efficient Training, Shikhar Murty           | Shikhar Murty (Stanford CS224N)                       | [docs/large-language-models-llms/uvx7sygckka.md](docs/large-language-models-llms/uvx7sygckka.md) | Explains hardware-level mixed precision (bfloat16), distributed parameter sharding (DDP/FSDP/ZeRO), and LoRA adaptation.            |
| Stanford CS224N: NLP w/ DL \| Spring 2024 \| Lecture 7 - Attention, Final Projects and LLM Intro      | Stanford CS224N Instructors                           | [docs/large-language-models-llms/j7rusoizhre.md](docs/large-language-models-llms/j7rusoizhre.md) | Traces machine translation evaluation (BLEU), sequence-to-sequence bottlenecks, and attention mechanism variants.                   |
| Stanford CS224N: NLP with Deep Learning \| Spring 2024 \| Lecture 10 - Post-training by Archit Sharma | Archit Sharma (Stanford CS224N)                       | [docs/large-language-models-llms/35x6zlhocy4.md](docs/large-language-models-llms/35x6zlhocy4.md) | Focuses on post-training alignment, instruction fine-tuning, emergent capabilities, and RLHF vs DPO trade-offs.                     |
| Stanford CS224N: NLP with Deep Learning \| Spring 2024 \| Lecture 11 - Benchmarking by Yann Dubois    | Yann Dubois (Stanford CS224N)                         | [docs/large-language-models-llms/to0cqzqiarm.md](docs/large-language-models-llms/to0cqzqiarm.md) | Critiques closed vs open-ended NLP evaluation, Chatbot Arena ELO ratings, data contamination, and LLM judge reliability.            |
| Stanford CS229 I Machine Learning I Building Large Language Models (LLMs)                             | Stanford CS229 Instructors                            | [docs/large-language-models-llms/9vm4p9nn0ts.md](docs/large-language-models-llms/9vm4p9nn0ts.md) | Provides an end-to-end overview of building LLMs across data curation, Chinchilla scaling laws, systems, and alignment.             |
| Stanford CS25: V5 I On the Biology of a Large Language Model, Josh Batson of Anthropic                | Josh Batson (Anthropic)                               | [docs/large-language-models-llms/vrqs7qfidau.md](docs/large-language-models-llms/vrqs7qfidau.md) | Demonstrates mechanistic interpretability using sparse autoencoders (dictionary learning) to discover concept features inside LLMs. |
| Stanford CS336 Language Modeling from Scratch \| Spring 2025 \| Lecture 1: Overview and Tokenization  | Percy Liang & Tatsu Hashimoto et al. (Stanford CS336) | [docs/large-language-models-llms/sq3fz1saqxi.md](docs/large-language-models-llms/sq3fz1saqxi.md) | Outlines hands-on, zero-scaffolding language modeling from scratch covering hardware efficiency, scaling laws, and tokenization.    |
| Stanford Webinar - Large Language Models Get the Hype, but Compound Systems Are the Future of AI      | Matei Zaharia et al. (Stanford Webinar)               | [docs/large-language-models-llms/vrtce19m-ke.md](docs/large-language-models-llms/vrtce19m-ke.md) | Argues that practical AI deployment relies on compound AI systems (models + prompts + tools + RAG) rather than standalone LLMs.     |
| Title not found                                                                                       | N/A                                                   | [docs/large-language-models-llms/ebnx5ur1hbk.md](docs/large-language-models-llms/ebnx5ur1hbk.md) | Placeholder note for unsummarized video transcript.                                                                                 |
