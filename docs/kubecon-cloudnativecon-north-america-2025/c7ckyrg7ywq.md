---
type: Video Note
title: "Keynote: Predictive Scaling and Capacity Planning With Machine Learni... Artur Souza & Chunpeng Wang"
description: "Amazon uses a combination of reactive and proactive scaling strategies to handle peak traffic during events like Black Friday. Reactive scaling relies on monitoring systems to detect high CPU utilization and trigger scaling actions, but it..."
