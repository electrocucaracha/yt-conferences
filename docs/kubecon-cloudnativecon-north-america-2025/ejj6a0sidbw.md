...
description:
  ...
  journey with Spark on Kubernetes. They migrated 38% of their production workload
  to Kubernetes in just a month, after starting the project over a year ago. The deci...
