...
The Operator Life Cycle Manager (OLM) is a project under the Cloud Native Computing Foundation (CNCF) aimed at providing automated life cycle management for operators on a cluster.
...
|   # | Main point                                                                                                                                                                  |
| --: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   1 | Operator Life Cycle Manager (OLM) is a project aimed at providing automated life cycle management for operators on a cluster.                                               |
...
|  15 | The revision-based life cycle management has improved the experience by providing a new unit of life cycle and making rollbacks and rollouts predictable and deterministic. |
