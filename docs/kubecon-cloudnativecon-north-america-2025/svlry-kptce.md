---
type: Video Note
title: "Your Kubernetes Playbook at Your Fingertips: Advanced Troubleshooti... David vonThenen & Yash Sharma"
description: "The speakers introduced a session focused on integrating AI with Kubernetes troubleshooting using a project called KGPT, which leverages large language models (LLMs) and retrieval-augmented generation (RAG) to analyze and remediate issues i..."
