...
The speaker, representing the CNCF, announces the conclusion of the last lightning talk and thanks the audience for staying until the end, expressing surprise at the large turnout.
...
|   # | Main point                                                                             |
| --: | -------------------------------------------------------------------------------------- |
|   1 | Speaker works for the CNCF.                                                            |
|   2 | This was the last lightning talk of the day.                                           |
|   3 | Thanks given to attendees for staying until the end.                                   |
|   4 | Appreciation expressed for the presenters of the lightning talks.                      |
|   5 | CubeCon officially starts tomorrow.                                                    |
|   6 | Keynotes will be held in the morning.                                                  |
|   7 | More project-specific sessions will follow.                                            |
|   8 | There is a project pavilion where CNCF staff and project presenters will be available. |
|   9 | Attendees are encouraged to visit the pavilion to meet and ask questions.              |
|  10 | Parties are scheduled for tomorrow night.                                              |
