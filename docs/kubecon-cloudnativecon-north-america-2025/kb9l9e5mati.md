...
Interested users can find more information, documentation, and ways to get involved on the project's site, GitHub, and Slack.
...
|   8 | Models stored in registries can be pulled and used with Kubernetes, mounted as local volumes, and accessed from pods like localStorage.                                                                |
...
|  12 | The site is up to date; contact is available via Slack and GitHub.                                                                                                                                     |
