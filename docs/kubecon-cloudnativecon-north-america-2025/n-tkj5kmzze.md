---
type: Video Note
title: "The Ultimate Container Challenge: An Interactive Trivia Game on Su... Aurélie Vache & Sherine Khoury"
description: 'The video presents the "Ultimate Kutan Challenge: Secret Chain Edition," an interactive quiz and demo session focused on supply chain security for container images. The hosts introduce themselves and guide participants through key concepts...'
