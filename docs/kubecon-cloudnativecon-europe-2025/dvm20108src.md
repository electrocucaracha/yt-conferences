...
Sebastian Blonde, a developer advocate for Port, introduced himself alongside Abby Bangzer, principal engineer at Centaso, to discuss Kubernetes' power and interaction models.
They highlighted three main interaction models: user personality (focusing on applications running in the cluster), administrator model (infrastructure-oriented), and developer model (extending Kubernetes).
The presentation focused on the developer model, explaining how custom resource definitions (CRDs) enable developers to extend Kubernetes.
...
[Watch on YouTube](https://www.youtube.com/watch?v=dVM20108SRc)
