...
description:
  ...
  provide a platform-agnostic way to deploy applications on various runtimes, including
  Kubernetes, serverless, and VMs. The goal is to shift abstraction from developers
  to...
