...
layout: default
title:
  "Mastering Efficiency in Argo CD: Scaling Smarter, Not Costlier - Alexander
  Matyushentsev, Akuity"
nav_order: 195
parent: Kubecon Cloudnativecon Europe 2025
type: Video Note
description:
  The speaker discusses the cost of running Argo CD at scale, highlighting
  that while it's initially free, costs can add up when managing multiple clusters
  and applications. They share lessons learned from their experience, including optimizi...
