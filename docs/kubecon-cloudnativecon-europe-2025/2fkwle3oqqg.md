...
The speaker, Taylor Thomas, is a CNCF WASM working group co-chair who presents an overview of WebAssembly (WASM).
He explains that WASM is a small, portable, and secure VM that can be built in any language and compiled to a binary, allowing it to run on various architectures and operating systems.
