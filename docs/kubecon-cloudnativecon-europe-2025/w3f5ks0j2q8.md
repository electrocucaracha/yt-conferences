...
description:
  ...
  and ease of integration with other backends. It's primarily an authoritative DNS
  server but can also handle recursive requests. The project is written in Go, a mem...
