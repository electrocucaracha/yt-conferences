...
description:
  ...
  communicate vulnerability impact to end-users. VEX is a system of documents that
  chronologically order vulnerabilities' impact on software. The goal is to make it
  easy f...
