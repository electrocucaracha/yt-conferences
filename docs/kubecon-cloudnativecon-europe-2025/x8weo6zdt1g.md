...
The speaker, No, discusses advanced security policies for gateways, specifically focusing on OpenWay (Gway) and its API.
They introduce a control plane to simplify proxy configuration, allowing users to define traffic policies without manual configuration.
...
[Watch on YouTube](https://www.youtube.com/watch?v=x8wEo6ZDT1g)
