...
description:
  ...
  that users' happiness is the ultimate goal. They acknowledge that returning a 503
  "unavailable" status code can be problematic, as it's meant to be retryable. Instead...
