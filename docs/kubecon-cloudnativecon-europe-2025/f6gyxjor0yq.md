...
description:
  ...
  when managing clusters. When a cluster has limited resources, pods may be allocated
  to either node, but without sufficient information, Kubernetes cannot guarantee...
