...
layout: default
title:
  Optimizing Model Serving on Kubernetes With Model Streaming - Ekin Karabulut
  & Ronen Dar, Run:ai
nav_order: 214
parent: Kubecon Cloudnativecon Europe 2025
type: Video Note
description:
  The speaker discusses optimizing model serving inference on a Kubernetes
  cluster with model weight streaming. They introduce Rani Model Weight Streamer,
  an open-source project that accelerates the process of loading model weights onto
  GPUs...
