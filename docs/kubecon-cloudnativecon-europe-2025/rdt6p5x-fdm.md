---
type: Video Note
title: "SIG Docs and You: Modernizing API Reference Generation - Kat Cosgrove & Xander Grzywinski"
description: "The current process for generating API reference docs for Kubernetes and Cube Control is manual, requiring a local workspace setup, fetching the open API spec, and modifying markdown files, which fails every time due to lack of automation a..."
resource: https://www.youtube.com/watch?v=RdT6P5x_fDM
...
[Watch on YouTube](https://www.youtube.com/watch?v=RdT6P5x_fDM)