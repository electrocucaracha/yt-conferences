---
type: Video Note
title: "What's New in Knative Eventing: Security, Discovery, Int... Pierangelo Di Pilato & Christoph Stäbler"
description: "The presentation discusses various features and updates in KNative Eventing, an open-source project for building event-driven systems. The security features include transport encryption via TLS, authentication via OpenID Connect, and author..."
