---
type: Video Note
title: "How We Moved Spotify To a Proxyless gRPC Service Mesh - Erik Lindblad & Erica Manno, Spotify"
description: "Spotify's service discovery system, Nameless, was facing limitations with DNS, including response size limits and uncertainty in service registration times. To address these issues, Spotify evaluated market-leading service mesh solutions an..."
